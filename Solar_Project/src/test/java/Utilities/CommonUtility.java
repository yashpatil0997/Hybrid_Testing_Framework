...
public class CommonUtility {
	public Properties getConfigProperties() throws IOException {
		...
		FileInputStream fis = new FileInputStream("C:\\Users\\User1\\eclipse-workspace\\Solar_automation_project\\src\\test\\resources\\Configfiles\\config.properties");
	...
	public Properties getLocator() throws IOException {
		...
		FileReader fr1 = new FileReader("C:\\Users\\User1\\eclipse-workspace\\Solar_automation_project\\src\\test\\resources\\Configfiles\\locators.properties");
	...
	public WebDriver initiateWebsite() throws IOException {
		...
		if (browser != null && browser.equalsIgnoreCase("Chrome")) {
	        ...
	        prefs.put("profile.default_content_setting_values.popups", 1); // 1 = Allow popups
	...
	public WebElement waitatelementpresenceOfElementLocated(WebDriver driver, int time, String xpath) {
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(time));
